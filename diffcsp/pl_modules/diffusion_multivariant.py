...
from diffcsp.pl_modules.diff_utils import d_log_p_wrapped_multivariate_normal
...
class CSPDiffusion(BaseModule):
    ...
    def forward(self, batch):
        ...
        tar_x = d_log_p_wrapped_multivariate_normal(sigmas_per_atom * rand_x, sigmas_per_atom) / torch.sqrt(sigmas_norm_per_atom)
